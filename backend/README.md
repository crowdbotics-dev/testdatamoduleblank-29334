...
## Project Structure
    ...
    ├── testdatamoduleblank_29334  # Django project configurations
...
1. Clone this repo and `cd testdatamoduleblank_29334`
...
2. Clone this repo and `cd testdatamoduleblank_29334`
